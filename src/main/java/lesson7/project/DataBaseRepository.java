...
public class DataBaseRepository {
    ...
    //private static final String DB_PATH = "jdbc:sqlite:geekbrains.db"; этот путь не работает почему то..
    private static final String DB_PATH = "jdbc:sqlite:C:\\sqlite\\geekbrains.db";
